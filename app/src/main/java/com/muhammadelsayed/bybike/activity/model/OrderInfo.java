...
public class OrderInfo implements Serializable {
    ...
    public OrderInfo(int id, String uuid, int status, String email, String password, String sender_Lat, String sender_Lng, String receiver_lat, String receiver_lng, String api_token, String created_at, String updated_at, User user) {
        this.id = id;
        this.uuid = uuid;
        this.status = status;
        this.email = email;
